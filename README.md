...
-  map() একটি Array এর প্রতিটি উপাদানের উপর চলে এবং নতুন একটি Array তৈরি করে। আর forEach() শুধু loop চালানোর জন্য ব্যবহার হয়।

3) What is the difference between == and ===?
-  == শুধু value তুলনা করে আর === value এবং মান দুইটাই তুলনা করে।

4) What is the significance of async/await in fetching API data?
-  Async/Await দিয়ে API call করতে সহজ হয় এবং call শেষ না হওয়া পর্যন্ত অপেক্ষা করে কোড। Error handling করা যায়।
